...
public class AStarSearchTest {
    ...
    private Heuristic<String> euclidianHeuristic;
    ...
    public void setUp() {
        ...
        euclidianHeuristic = (graph, current, terminationCondition, costSoFar) -> costSoFar + distancesToFaro.get(current);
    }


    /*
     * AStarSearch(Graph<V, Double> graph, V source, Predicate<State> terminationCondition, Heuristic<V> heuristic)
     */

    @Test(expected= NoSuchElementException.class)
    public void constructorFailsIfSourceVertexDoesNotExist() {
        new AStarSearch<>(map, "Tondela", new FindTargetCondition<>(map, "Faro"), euclidianHeuristic);
    }
    ...
    public void searchFindsSource() throws NoPathFoundException {
        AStarSearch<String> searcher = new AStarSearch<>(map, "Faro", new FindTargetCondition<>(map, "Faro"),
                euclidianHeuristic);
    ...
    public void searchFindsNeighbour() throws NoPathFoundException {
        AStarSearch<String> searcher = new AStarSearch<>(map, "Setubal", new FindTargetCondition<>(map, "Faro"),
                euclidianHeuristic);
    ...
    public void searchFindsShortestDistanceBetweenCoimbraAndFaro() throws NoPathFoundException {
        AStarSearch<String> searcher = new AStarSearch<>(map, "Coimbra", new FindTargetCondition<>(map, "Faro"),
                euclidianHeuristic);
    ...
    public void searchFailsIfThereIsNoPath() throws NoPathFoundException {
        ...
        AStarSearch<String> searcher = new AStarSearch<>(map, "Tondela", new FindTargetCondition<>(map, "Faro"),
                euclidianHeuristic);
        searcher.search();
    }
}
